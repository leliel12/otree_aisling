...
SESSION_CONFIGS = [
    ...
    {
        'name': 'trust',
        'display_name': "Trust (Reveal Type – Trustworthy go first)",
        'num_demo_participants': 2,
        'auto_ttype': True,
        "treatment_reveal_type": True,
        "treatment_trustworthy_first": True,
        'app_sequence': ['trust'],
    },
    {
        'name': 'full_game_rt',
        'display_name': "Full Game (Reveal Type – Trustworthy go first)",
        'num_demo_participants': 2,
        "treatment_reveal_type": True,
        "treatment_trustworthy_first": True,
        'app_sequence': ['big_five',
    ...
    {
        'name': 'full_game_ru',
        'display_name': "Full Game (Reveal Type – Untrustworthy go first)",
        'num_demo_participants': 2,
        "treatment_reveal_type": True,
        "treatment_trustworthy_first": False,
        'app_sequence': ['big_five',
                         'gssas_holtlaury',
                         'trust_type_check',
                         'trust'],
    ...
    {
        'name': 'full_game_nt',
        'display_name': "Full Game (No Reveal type – Trustworthy go first)",
        'num_demo_participants': 2,
    ...
    {
        'name': 'full_game_nu',
        'display_name': "Full Game (No reveal type – Untrustworthy go first)",
        'num_demo_participants': 2,
        "treatment_reveal_type": False,
        "treatment_trustworthy_first": False,
        'app_sequence': ['big_five',
